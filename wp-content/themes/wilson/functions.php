...
function wilson_load_style() {
	if ( !is_admin() ) {
	    wp_enqueue_style( 'wilson_googleFonts', '//fonts.googleapis.com/css?family=Noticia+Text:400,400italic,700,700italic|Raleway:400,700' );
...
function wilson_add_editor_styles() {
    ...
    $font_url = '//fonts.googleapis.com/css?family=Noticia+Text:400,400italic,700,700italic|Raleway:400,700';
